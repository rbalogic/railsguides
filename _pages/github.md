...
Then, for scopes, select the top "repo" checkbox, that gives the PAT "Full control of private repositories". Also select the "workflow" checkbox to give the PAT "Update GitHub Action workflows" permission. This is required if your app includes a `.github/workflows/` directory (e.g., generated by Rails 8).
